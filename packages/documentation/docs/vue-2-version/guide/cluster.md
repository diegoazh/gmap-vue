...
:::note Click to se the source code of <code>cluster.vue</code> component
...
:::note Mapped Props of <code>GmapCluster</code> component
...
If you need to know the **API of this component** please read it [here](/docs/vue-2-version/code/components/cluster-icon).
