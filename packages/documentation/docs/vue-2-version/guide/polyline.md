...
:::note Click to se the source code of <code>polyline.vue</code> component
...
:::note Mapped Props of <code>GmapPolyline</code> component
...
If you need to know the **API of this component** please read it [here](/docs/vue-2-version/code/components/polyline-shape).

## HTML examples

:::note Simple polyline example
