...
:::note Click to se the source code of <code>polygon.vue</code> component
...
:::note Mapped Props of <code>GmapPolygon</code> component
...
:::note Events bound with to way on <code>GmapPolygon</code>
...
If you need to know the **API of this component** please read it [here](/docs/vue-2-version/code/components/polygon-shape).

## HTML examples

:::note Simple polygon example
